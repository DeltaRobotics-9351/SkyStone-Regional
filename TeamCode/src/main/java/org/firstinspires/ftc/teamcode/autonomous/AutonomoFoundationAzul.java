...
public class AutonomoFoundationAzul extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        timeDrive.forward(0.8,0.8); //avanzamos hacia la foundation
        ...
        timeDrive.backwards(1, 0.8);// vamos hacia atras para jalar la foundation
        timeDrive.strafeRight(0.5, 4); //nos deslizamos para estacionarnos abajo del skybridge
